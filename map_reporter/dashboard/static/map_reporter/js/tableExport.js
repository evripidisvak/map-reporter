...
(function ($) {
  $.fn.tableExport = function (options) {
              ...
              ForEachVisibleCell(this, colselector, rowIndex, length,
                function (cell, row, col) {
                  ...
                  if (typeof cell !== 'undefined' && cell !== null) {
                    ...
                    if (typeof (cell.children[0]) !== 'undefined' && cell.children[0].classList.contains('prod-img')) {
                      cellContent = {
                        image: parseString(cell, row, col, 'text', true),
                        fit: [60, 60],
                      }
                    } else {
    ...
    function parseString(cell, rowIndex, colIndex, cellInfo, isimage) {
      let result = '';
      let cellType = 'text';
      ...
      if (cellInfo !== undefined) {
        if (isimage == true) {
          result = cell.children[0].attributes['aria-src'].textContent;
        } else {
